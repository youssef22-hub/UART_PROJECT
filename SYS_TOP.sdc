...
# Created by write_sdc on Mon Sep 29 20:45:40 2025
...
set_clock_groups -asynchronous -name CLK_REF_1 -group [list [get_clocks CLK_REF] [get_clocks CLK_ALU]] -group [list [get_clocks CLK_RX] [get_clocks CLK_TX] [get_clocks CLK_UART]]
