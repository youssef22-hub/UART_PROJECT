...
create_generated_clock -name CLK_RX -master_clock CLK_UART -source [get_ports UART_CLK] \
    -divide_by 1  [get_port clk_div_rx_dut/o_div_clk]
...
create_generated_clock -name CLK_TX -master_clock CLK_UART -source [get_ports UART_CLK] \
    -divide_by 32 [get_port clk_div_tx_dut/o_div_clk]
...
create_generated_clock -name CLK_ALU -master_clock CLK_REF -source [get_ports REF_CLK] \
    -divide_by 1  [get_port clk_gate_dut/GATED_CLK]
set_clock_uncertainty -setup 0.2 [get_clocks CLK_ALU]
set_clock_uncertainty -hold  0.1 [get_clocks CLK_ALU]


create_clock -name S_CLK  -period $clk -waveform {0 135.6483993}      [get_ports scan_clk]
set_clock_uncertainty -setup 0.2 [get_clocks S_CLK]
set_clock_uncertainty -hold  0.1 [get_clocks S_CLK]
set_clock_transition 0.5          [get_clocks S_CLK]
set_clock_latency    0            [get_clocks S_CLK]

set_clock_groups -asynchronous -group [get_clocks "CLK_REF CLK_ALU"] -group [get_clocks "CLK_RX CLK_TX CLK_UART"] -group [get_clocks S_CLK]
set_multicycle_path -setup 32 -from CLK_TX -to CLK_UART
set_multicycle_path -setup 31 -from CLK_TX -to CLK_UART

set_dont_touch_network [get_clocks {CLK_UART CLK_REF CLK_TX CLK_RX CLK_ALU S_CLK}]
...
set_input_delay  $delay   -clock CLK_RX [get_ports SI]
set_output_delay $delays -clock CLK_TX [get_ports SO]

set_input_delay  $delay   -clock CLK_RX [get_ports SE]
